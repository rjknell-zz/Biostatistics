...
```{r mean4, exercise = TRUE, fig.height = 5, fig.width =4, exericise.lines = 8, exercise.setup = "prepare-height"}
...
```{r spread1, exercise = TRUE, exercise.lines = 6, exercise.setup = "prepare-height"}
