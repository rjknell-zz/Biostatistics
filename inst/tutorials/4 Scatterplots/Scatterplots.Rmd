...
```{r scatterplot01, exercise = TRUE, exercise.setup = "prepare-carbon"}
...
```{r scatterplot02, exercise = TRUE, exercise.setup = "prepare-carbon"}
...
```{r scatterplot1, exercise = TRUE, exercise.setup = "prepare-worldbank"}
...
```{r scatterplot3, exercise = TRUE, exercise.setup = "prepare-carnivores"}
...
mammal_longevity <- 
  read.csv(
  "http://research.sbcs.qmul.ac.uk/r.knell/learnr_data/mammal_longevity.csv"
)
...
```{r scatterplot5, lines = 25, exercise = TRUE, exercise.setup = "prepare-mammals"}
